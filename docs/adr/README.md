...
| [0022](0022-ingesters-normalize-not-fetch.md) | `crate add` normalizes content you already have; the engine never fetches | Fetching is deterministic so ADR-0004 would allow it — but the cost is network deps, not judgment |
